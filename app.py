...
def recipes_results():
    if request.method == 'POST':
        ...
        recipe_id2 = getRecipeFromIngredients1(query, number, key)
        recipe_info2 = getRecipeInfo2(recipe_id2, key)
        recipe_id3 = getRecipeFromIngredients1(query, number, key)
        recipe_info3 = getRecipeInfo3(recipe_id3, key)
        recipe_id4 = getRecipeFromIngredients1(query, number, key)
        recipe_info4 = getRecipeInfo4(recipe_id4, key)
        recipe_id5 = getRecipeFromIngredients1(query, number, key)
        recipe_info5 = getRecipeInfo5(recipe_id5, key)
        recipe_id6 = getRecipeFromIngredients1(query, number, key)
        recipe_info6 = getRecipeInfo6(recipe_id6, key)
        recipe_id7 = getRecipeFromIngredients1(query, number, key)
        recipe_info7 = getRecipeInfo7(recipe_id7, key)
        recipe_id8 = getRecipeFromIngredients1(query, number, key)
        recipe_info8 = getRecipeInfo8(recipe_id8, key)
        recipe_id9 = getRecipeFromIngredients1(query, number, key)
        recipe_info9 = getRecipeInfo9(recipe_id9, key)
        recipe_id10 = getRecipeFromIngredients1(query, number, key)
